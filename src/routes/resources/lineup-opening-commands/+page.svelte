...
<svelte:head>
	<MetaTags
		title="Lineup Opening Commands"
		description="Commands said during lineup at the beginning of practice, with instructions, English pronunciation, and Japanese characters."
	/>
</svelte:head>
