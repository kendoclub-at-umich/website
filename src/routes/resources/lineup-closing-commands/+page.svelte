...
<p>
	...
	<span class="secondary">
		...
		you are the anchor point that everyone else will need to follow. Be quick to return to the
...
<p>
	<span class="secondary">
		Wait for all of the people to line up standing along-side your position and in a straight line.<br
		/>
...
<p>
	...
	<span class="secondary">
		...
		what they worked on that day. Typically this should last for 2 deep breaths. If time is short,
		maybe shortened.<br />
	</span>
</p>
...
<p>
	...
	<span class="secondary">
		...
		briefly so everyone has a chance to face the direction of the Sensei.<br />
	</span>

	<span class="secondary">
		Be certain to allow enough time for the line-up to change direction.
	</span><br />
	“Ray !!” Bow from Seiza position.<br />
	礼（れい）<br />
</p>
...
<p>
	...
	“Ray !!” Bow in the Seiza position<br />
	礼（れい）<br />
</p>
